...
By definition, U1 measures the extent to which the largest unnormalized output of the neural network deviates  
from the remaining outputs, while U2 measures the extent to which the remaining smaller outputs deviate from each other.   
...
#### 2) Input preprocessing 식에서 theta와 sign함수의 의미. 
